...
\begin{mdframed}[linewidth=0.6pt,backgroundcolor=verylightblue,innerleftmargin=6pt,innerrightmargin=6pt,innertopmargin=4pt,innerbottommargin=4pt,nobreak=true]
\begin{definition}[BDGR Definition of $\phi$~\cite{BDGR21}]
\label{def:bdgr}
...
$\quad\text{where }V=\min\bigl(\owedge^{\{U\}}(Views)\bigr).$ This predicate is asserting an \emph{equality of counts}.
