...
Paper-based systems such as Pr{\^e}t-\`a-Voter and Scantegrity~\cite{CCC+08} add additional constraints to the paper ballot by adding random candidate permutations and confirmation codes.
