...
Since the candidate labeling $S$ is determined by the public ballot structure, the tuples disclosed by the print-audit view determine a $(U,S)$-projection that must match $\pi_{U,S}(E^Z)$ on the opened rows. 
